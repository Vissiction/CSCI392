...
{
	private int maxValues;		// Maximum size of values[]
	private int values[];		// Will hold the count for each group
	private int groupSize = 10;	// Size of each group
	private int groupsToPrint = 0;	// Size of values[], up to the largest nonzero index
